...
const imgs = {
  ...
  grass: "https://pm1.narvii.com/7243/0b36782d158f6da0639e38ebf94af3d5c37288c2r1-668-486v2_hq.jpg",
  electric: "https://pm1.narvii.com/7243/00eaa3cfd5033ff306b23965e1c50b31577dd464r1-647-485v2_hq.jpg",
  water: "https://pm1.narvii.com/7243/46d5cfd672a1e2fca16c78d728e2b10cb57f7ce0r1-669-521v2_hq.jpg",
  ground: "https://pm1.narvii.com/7243/10ed1c931a1b46035f01315731b1f3f70ec24f5er1-656-454v2_hq.jpg",
  rock: "https://pm1.narvii.com/7243/843acea2bde21f7ae7e1f17c0da831acea46a2acr1-692-503v2_hq.jpg",
  fairy: "https://pm1.narvii.com/7243/61770aa4b0259c06cd4b1fa490007c29e27d6683r1-663-565v2_hq.jpg",
  poison: "https://pm1.narvii.com/7243/b0945fed2f0cc9fa340c6e7deb851c14ddf53e30r1-575-530v2_hq.jpg",
  bug: "https://pm1.narvii.com/7243/0d2736d705781ea116d08621abbfefae60a971c2r1-700-542v2_hq.jpg",
  dragon: "https://pm1.narvii.com/7243/8ee17e7a8790303410b30a2fbcb18183fc12166er1-623-499v2_hq.jpg",
  psychic: "https://pm1.narvii.com/7243/19a53b46a48f55a346f130092cb2c8d8fcf88af0r1-642-671v2_hq.jpg",
  flying: "https://pm1.narvii.com/7243/bc538f6da74b633d36b48108ddd07b7a2410a2afr1-650-498v2_hq.jpg",
  fighting: "https://pm1.narvii.com/7243/250af9c70a9f5140d4ba66922a9f227dd0bbe885r1-731-341v2_hq.jpg",
  normal: "https://pm1.narvii.com/7243/f2fb9db8191078f72c8b98fee93155c56e6e8674r1-673-421v2_hq.jpg",
...
const fetchPokemons = async () => {
  ...
  const drawPokemons = async () => {
    for (let i of resjson.results) {
      ...
      li$$.innerHTML = `<h2>${pokedata.name}</h2><div class="imageContainer"><img src="${pokedata.sprites.front_default}" /></div><p>${typeDataString}</p><p>${pokedata.id}</p>`;
      ol$$.appendChild(li$$);
...
const drawPokemonFilter = async (value) => {
  ...
  for (const result of resultsInput) {
    ...
    li$$.setAttribute("class", "card");
    li$$.style.backgroundImage = `url('${img}')`;
    li$$.innerHTML = `<h2>${res2json.name}</h2><div class="imageContainer"><img src="${res2json.sprites.front_default}" /></div><p>${typeDataString}</p><p>${res2json.id}</p>`;
    ol$$.appendChild(li$$);
  }
